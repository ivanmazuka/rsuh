    ...
    <main>
        ...
        <section>
            <table class="contacts" cellspacing="0">
                ...
                <tr>
                    <td colspan="3">
                        <h3>Кафедра фундаментальной и прикладной математики</h3>
                    </td>
                </tr>
                <tr>
                    <td>Заведующий</td>
                ...
                <tr>
                    <td colspan="3">
                        <h3>Кафедра информационных технологий и систем</h3>
                    </td>
                </tr>
                <tr>
                    <td>Заведующий</td>
                ...
                <tr>
                    <td colspan="3">
                        <h3>Кафедра информационной безопасности</h3>
                    </td>
                </tr>
                <tr>
                    <td>Заведующий</td>
                ...
                <tr>
                    <td colspan="3">
                        <h3>Кафедра комплексной защиты информации</h3>
                    </td>
                </tr>
                <tr>
                    <td>Заведующий</td>
                ...
                <tr>
                    <td colspan="3">
                        <h3>Лаборатория компьютерной техники и средств защиты</h3>
                    </td>
                </tr>
                <tr>
